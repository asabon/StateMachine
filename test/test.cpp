...
TEST_F(Test_statemachine_do, test_01)
{
    ...
    EXPECT_CALL(*mocks, state10_do(testing::_)).WillRepeatedly(testing::Return(0)).WillRepeatedly(testing::SetArgReferee<0>(1));
    ...
    EXPECT_CALL(*mocks, state11_do(testing::_)).WillRepeatedly(testing::Return(0)).WillRepeatedly(testing::SetArgReferee<0>(0));
